<div class="row">
    <div class="col-md-9">
        <div class="btn-demo" id="toolbar">
            <a v-show="delivery.state==0" class="btn btn-info-alt" @click="add_record">新 增</a>
                ...
                <template v-for="(index,item) in originRecordList">
                    <tr>
                        ...
                        <td class="table-action text-center">
                            ...
                            <a v-show="delivery.state==0" class="btn btn-sm btn-success-alt" href="/distribute/changeOriginRecord?record_id={{item.id}}" target="_blank">修改</a>
                            <a v-show="delivery.state==0" class="btn btn-sm btn-danger-alt" @click="del_record(item)">删除</a>
                        </td>
                    </tr>
                </template>
                </tbody>
