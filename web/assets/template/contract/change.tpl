                    ...
                    methods: {
                        ...
                        saveAsProject: function () {
                            ...
                            jQuery.fn.check_msg({
                                ...
                                msg: "您即将完成当前合同的修改,修改完成之后将重新进入项目流中,是否修改？",
                                success: function () {
                                    jQuery.fn.alert_msg("合同修改成功！");
                                }
                            });
                        },
                        /**
...
//                            });
                ...
                LIMS.dialog_lg.$set('title', '变更合同信息');
                LIMS.dialog_lg.currentView = 'contract_view' + data.id;
            },
            stop_item: function (data) {
                var me = this;
                jQuery.fn.check_msg({
                    msg: "⚠️警告,您正在进行<span class='text-danger'>中止合同</span>操作,合同编号为<span class='text-danger'>【" + data.identify + "】</span>,该操作不可逆,是否进行？",
                    success: function () {
        ...
        ready: function () {
            var me = this;
            me.$http.get("/assets/json/contract_list.json").then(function (response) {
                var data = response.data;
                console.log(data);
