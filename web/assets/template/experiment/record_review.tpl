                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="btn-demo">
                            ...
                            <a class="btn btn-primary-alt" @click="viewReceiveInfo(id)" v-if="experience_secondReview"
                               data-toggle="modal"
            ...
            methods: {
                ...
                load_projectlist: function (id) {
                    ...
                    me.$http.get("/sample/getProjectListByDelivery", {
                        ...
                        me.$set("projectList", data.results);
                        me.$set("experience_secondReview", data.experience_secondReview);
                    }, function (response) {
                ...
                review: function (task_id, identify, state) {
                    ...
                    jQuery.fn.check_msg({
                        ...
                        success: function () {
                            ...
                            me.$http.post("/review/checkSecondOriginReview", data).then(function (response) {
                                var data = response.data;
                                jQuery.fn.codeState(data.code, {
                                    200: function () {
                                        me.$http.post("/flow/receiveSecondFlow", {
                                            task_id: task_id,
                                            state: state
                                        }).then(function (response) {
                                            var data = response.data;
                ...
                pending: function (task_id) {
                    var me = this;
                    var template = jQuery.fn.loadTemplate("/assets/template/subject/record_review.tpl");
                    Vue.component('record_review' + task_id, {
                        template: template,
                        data: function () {
                            return {
                                task_id: task_id,
                        ...
                        methods: {
                            addReview: function () {
                                var that = this;
                                that.$http.post("/review/addSecondReview", that._data).then(function (response) {
                                    var data = response.data;
                                    jQuery.fn.codeState(data.code, {
                                        200: function () {
                        ...
                        ready: function () {
                            var that = this;
                            that.$http.get("/review/getSecondReviewInfo", {
                                params: {
                                    task_id: task_id
                                }
                            }).then(function (response) {
                    ...
                    LIMS.dialog_lg.currentView = 'record_review' + task_id;
                },
