 ...
 * <p>
 * 
 * @author 瞿龙俊 新增日期：2015-9-23
 * @author 瞿龙俊 修改日期：2015-9-23
 * @since wapportal_manager version(2.0)
 */
public class PropertiesUtlis {

	private static Logger _log = Logger.getLogger(PropertiesUtlis.class);
	...
	private static Properties loadPropertyFile(String propertyFilePath) {
		java.io.InputStream is = PropertiesUtlis.class
	...
	public final static boolean setValueAndStore(String propertyFilePath,
		...
		try {
			...
			String path = PropertiesUtlis.class.getResource(propertyFilePath)
					.getPath();
