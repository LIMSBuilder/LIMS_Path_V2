        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p v-if="result_list.length==0">暂无待交联的任务。</p>
            ...
            methods: {
                                        ...
                                        success: function () {
                                            ...
                                            me.$http.post("/delivery/save", {
                                                ...
                                                if (data.code != 200) {
                                                    ...
                                                    me.$http.post("/flow/connectionFlow", {id: id}).then(function (response) {
                                                        var data = response.data;
                ...
                flow: function (item) {
                    ...
                    jQuery.fn.check_msg({
                        ...
                        success: function () {
                            me.$http.post("/flow/connectionFlow", {id: item.id}).then(function (response) {
                                var data = response.data;
                                jQuery.fn.codeState(data.code, {
                                    200: function () {
                                        jQuery.fn.alert_msg("任务流转成功!");
